...
CANDIDATES="${GENE}_NOCDS_AUGUSTUS_confirmed.fasta"
PFAM_DB="Pfam-A.hmm"
...
FULL_FILE="${GENE}_NOCDS_AUGUSTUS_confirmed_full_copies.fasta"
PARTIAL_FILE="${GENE}_NOCDS_AUGUSTUS_confirmed_partial_copies.fasta"
